...
from soulstruct.havok.types.hk2014 import hknpPhysicsSceneData, hknpPhysicsSystemData
from soulstruct.havok.fromsoft.base.utilities import scale_hknp_shape, scale_constraint_data
