...
from soulstruct.havok.spline_compression import *
from soulstruct.havok.tagfile.unpacker import MissingCompendiumError
...
try:
    from soulstruct.havok.utilities.vispy_window import VispyWindow
except ImportError:
    VispyWindow = None
