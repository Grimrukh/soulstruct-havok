...
def get_shared_types(modules: list[ModuleType]) -> dict[str, dict[str, set[tuple[str, str]]]]:
    ...
    for module in modules:
        ...
        for name, obj in inspect.getmembers(module, inspect.isclass):
            ...
            if not obj.__module__.startswith("soulstruct.havok.types.hk") or obj.__module__.endswith(".hk"):
                continue
...
def generate_pyi(shared_types: dict[str, dict[str, tp.Any]], output_file: Path | str):
    ...
    with Path(output_file).open("w") as f:
        ...
        # Docstring.
        f.write("\"\"\"\n")
        f.write("This file was generated by `soulstruct.havok.types._create_typing.py`.\n")
        ...
        f.write("from soulstruct.havok.types.base import *\n")
        f.write("from soulstruct.havok.types.hk import hk\n")
        f.write("from soulstruct.havok.utilities.maths import *\n\n")
