...
# region Physics
PHYSICS_DATA_T = tp.TypeVar("PHYSICS_DATA_T", hk2010.hkpPhysicsData, hk2015.hkpPhysicsData)
PHYSICS_SYSTEM_T = tp.TypeVar("PHYSICS_SYSTEM_T", hk2010.hkpPhysicsSystem, hk2015.hkpPhysicsSystem)
# endregion


# region Skeletons
SKELETON_T = tp.TypeVar("SKELETON_T", hk2010.hkaSkeleton, hk2014.hkaSkeleton, hk2015.hkaSkeleton, hk2018.hkaSkeleton)
BONE_T = tp.TypeVar("BONE_T", hk2010.hkaBone, hk2014.hkaBone, hk2015.hkaBone, hk2018.hkaBone)
# endregion


# region Ragdolls
RAGDOLL_INSTANCE_T = tp.TypeVar("RAGDOLL_INSTANCE_T", hk2010.hkaRagdollInstance, hk2015.hkaRagdollInstance)
