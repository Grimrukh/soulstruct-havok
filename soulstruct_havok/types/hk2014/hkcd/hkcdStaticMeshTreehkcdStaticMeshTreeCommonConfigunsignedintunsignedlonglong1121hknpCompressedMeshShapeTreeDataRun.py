...
if tp.TYPE_CHECKING:
    from ..hknp.hknpCompressedMeshShapeTreeDataRun import hknpCompressedMeshShapeTreeDataRun
...
def deferred_hknpCompressedMeshShapeTreeDataRunData():
    ...
    from ..hknp.hknpCompressedMeshShapeTreeDataRunData import hknpCompressedMeshShapeTreeDataRunData
